        ...
        child: Column(
          ...
          children: [
            ...
            if (isOurs && state == VpnState.connected) ...[
              ...
              Row(
                children: const [
                  _LegendDot(color: Color(0xFF6EE7B7)),
                  SizedBox(width: 4),
                  Text('download', style: TextStyle(fontSize: 11)),
                  SizedBox(width: 12),
                  _LegendDot(color: Color(0xFFFCD34D)),
                  SizedBox(width: 4),
                  Text('upload', style: TextStyle(fontSize: 11)),
                ],
              ),
            ],
          ],
...
class _ConnectButtonState extends ConsumerState<_ConnectButton>
  ...
  Widget build(BuildContext context) {
    ...
    final List<Color> grad = connected
        ? const [Color(0xFF10B981), Color(0xFF059669)]
        : connecting
            ? const [Color(0xFFF59E0B), Color(0xFFD97706)]
            : const [Color(0xFF6EE7B7), Color(0xFF14B8A6)];

    return AnimatedBuilder(
      animation: _pulse,
      builder: (_, __) {
        final glow = connecting
            ? 10 + 18 * _pulse.value
            : connected
                ? 14.0
                : 6.0;
        return Opacity(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: grad.last.withOpacity(0.55),
                  blurRadius: glow,
                  spreadRadius: 1,
                ),
              ],
                  ...
                  child: Row(
                    ...
                    children: [
                      if (connecting)
                        ...
                        Icon(
                          connected ? Icons.power_settings_new : Icons.play_arrow_rounded,
                          color: Colors.black87,
                          size: 28,
                        ),
